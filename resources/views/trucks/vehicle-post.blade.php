...
<div class="">
    <div class="user-dash">
        ...
        <div class="search_form post_truck_form">
            <div class="container">
                <form method="get" action="" id="post_truck" name="post_truck">
                    <div class="row">
                       <div class="col-lg-6">
                            ...
                            <div class="form-group truck_brand">
                                ...
                                <select name="vehicle_brand" id="vehicle_brand" class="form-control">
                                    ...
                                    @foreach ($VehicleBrand as $vehicle_Brand)
                                        ...
                                        <option value="{{$vehicle_Brand->brand_name}}">{{$vehicle_Brand->brand_name}}</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="truck_size">
                                    ...
                                    <div class="truck_props">
                                        ...
                                        <input type="number" class="form-control" name="hieght" id="hieght" />
                                    </div>
                                    <div class="truck_props">
                        ...
                        <div class="col-lg-6">                            
                            ...
                            <div class="form-group">
                                ...
                                <div id="" class="input-group date" data-date-format="mm/dd/yyyy">
                                    <input id="available_date_from" name="available_date_from" class="form-control" type="text" placeholder="Anytime" readonly />
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                @foreach ($equipments as $equipmentsValue)
                                    ...
                                    <input type="checkbox" name="equipment[]" value="{{$equipmentsValue->id}}">&nbsp{{$equipmentsValue->type}}&nbsp&nbsp
