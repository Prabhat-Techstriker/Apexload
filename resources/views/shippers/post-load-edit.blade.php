...
<div class="">
    <div class="user-dash">
        ...
        <div class="container">
            <form method="get" action="" id="post_load_edit" name="post_load">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label for=""><i class="text-danger fas fa-map-marker-alt"></i>Select Origin Location</label>
                            <input type="text" name="search_input1" id="search_input1" class="form-control" placeholder="Choose Location" value="{{$postloads->orign_name}}">
                            <input type="hidden" name="orign_name" id="orign_name" value="{{$postloads->orign_name}}">
                            <input type="hidden" name="orign_lat" id="orign_lat" value="{{$postloads->orign_lat}}">
                            <input type="hidden" name="orign_long" id="orign_long" value="{{$postloads->orign_long}}">
                            <input type="hidden" name="post_id" value="{{$postloads->id}}">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label for=""><i class="text-success fas fa-map-marker-alt"></i>Select Destination Location</label>
                            <input type="text" name="search_input2" id="search_input2" class="form-control" placeholder="Choose Location" value="{{$postloads->destination_name}}">
                            <input type="hidden" name="destination_name" id="destination_name" value="{{$postloads->destination_name}}">
                            <input type="hidden" name="destination_lat" id="destination_lat" value="{{$postloads->destination_lat}}">
                            <input type="hidden" name="destination_long" id="destination_long" value="{{$postloads->destination_long}}">
                        </div>                      
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="load_details_box">
                            <div class="load_detail">
                                ...
                                <input type="text" name="pickup_date" class="date" value="{{$postloads->pickup_date}}" autocomplete="off">
                            </div>
                            <div class="load_detail">
                                <span>Equipment type</span>
                                @foreach ($equipments as $equipmentsValue)
                                        <label><input type="checkbox" name="equipment[]"  value="{{$equipmentsValue->id}}" 
                                            @if(in_array($equipmentsValue->id, $postloads->equipment))
                                              checked="checked"
                                            @endif
                                        >{{$equipmentsValue->type}}</label>
                                @endforeach
                            </div>
                            <div class="load_detail">
                                <span>Load</span>
                                <input type="text" name="load" value="{{$postloads->load}}">
                            </div>
                            <div class="load_detail">
                                <span>Weight(Ibs)</span>
                                <input type="text" name="weight" value="{{$postloads->weight}}">        
                            </div>
                            <div class="load_detail">
                                <span>Length(ft)</span>
                                <input type="text" name="lenght" value="{{$postloads->lenght}}">
                            </div>
                            <div class="load_detail">
                                <span>Height(ft)</span>
                                <input type="text" name="hieght" value="{{$postloads->hieght}}">
                            </div>
                            <div class="load_detail">
                                <span>Width(ft)</span>
                                <input type="text" name="width" value="{{$postloads->width}}">
                            </div>
                            <div class="load_detail">
                                <span>Pieces</span>
                                <input type="text" name="pieces" value="{{$postloads->pieces}}">
                            </div>
                            <div class="load_detail">
                                <span>Quantity</span>
                                <input type="text" name="quantity" value="{{$postloads->quantity}}">
                            </div>
                            <div class="load_detail">
                                <span>Set Price(USD)</span>
                                <input type="text" name="set_price" value="{{$postloads->set_price}}">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12">
                            ...
                            <div class="card">
                                ...
                                <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                                    ...
                                    <div class="load_details_box">
                                        <div class="load_detail">
                                            <span>Name</span>
                                            <input type="text" name="com_name" value="{{$postloads->com_name}}">
                                        </div>
                                        <div class="load_detail">
                                            <span>Contact</span>
                                            <input type="text" name="com_phone" value="{{$postloads->com_phone}}">
                                        </div>
                                        <div class="load_detail">
                                            <span>Email</span>
                                            <input type="text" name="com_email" value="{{$postloads->com_email}}">
                                        </div>
                                        <div class="load_detail">
                                            <span>Office</span>
                                            <input type="text" name="com_office" value="{{$postloads->com_office}}">
                                        </div>
                                        <div class="load_detail">
                                            <span>Fax</span>
                                            <input type="text" name="com_fax" value="{{$postloads->com_fax}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
