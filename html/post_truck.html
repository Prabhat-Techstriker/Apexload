...
<html lang="en">
  <head>
	...
	<title>Apexloads | Post Truck</title>
    <!-- Bootstrap CSS -->
  ...
  <body>
	...
	<header class="page_header post_truck_header">
		 <h1>Post Truck</h1>
	</header>
	
	<div class="search_form post_truck_form">
		<div class="container">
			<form method="get" action="file.php" id="search_trucks" name="post_truck">
				<div class="row">
					<div class="col-lg-6">
						...
						<div class="form-group">
							<label for=""><img src="images/miles_icon.png" alt="Icon" />Miles <span><strong id="miles_value"></strong> mi</span></label>
							<div class="rSlider">
							    <span class="slide"></span>
								<input name="" id="range" value="75" type="range" min="0" max="5000" >
							</div>
							
						</div>
						
						<div class="form-group">
							<label for=""><img  class="gray_scale" src="images/truck_icon.png" alt="Icon" />Equipment Type</label>
							<select name="" id="" class="form-control js-select2">
							  <option>Any</option>
							  <option>Select A</option>
							  <option>Select B</option>
					...
					<div class="col-lg-6">
						...
						<div class="form-group">
							...
							<div id="" class="input-group date" data-date-format="mm-dd-yyyy">
								<input id="" name="" class="form-control" type="text" placeholder="Anytime" readonly />
						...
						<div class="form-group truck_brand">
							<label for=""><img  class="gray_scale" src="images/delivery_icon.png" alt="Icon" /></label>
							<select name="" id="" class="form-control">
							  <option>Truck Brand Name</option>
							  <option>Tata</option>
						...
						<div class="form-group truck_number">
							<label for=""><img  class="gray_scale" src="images/one_icon.png" alt="Icon" />Truck Number</label>
		...
		<div class="row">
			<div class="col-lg-4 col-md-6 offset-md-6">
				...
				<div class="dwnd_icons">
					<a href=""><img src="images/app_store.png" alt="Image" /></a>
					<a href=""><img src="images/g_play.png" alt="Image" /></a>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="newsletter container">
		<div class="row">
			<div class="col-lg-6 offset-lg-3">
				...
				<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
				<form method="get" action="file.php" id="newsletter" name="newsletter">
